...
public class ViewCabs extends JFrame implements Runnable {
    ...
    public void run() {
        try {
            ...
            l2.setVisible(true);
            caption.setText("ambulance1");
            l2.add(caption);
            Thread.sleep(2800);
            l2.setVisible(false);
            l3.setVisible(true);
            caption.setText("ambulance2");
            l3.add(caption);
            l3.setVisible(true);
            Thread.sleep(2800);
            l3.setVisible(false);
            l4.setVisible(true);
            caption.setText("ambulance3");
            l4.add(caption);
            Thread.sleep(2800);
            l4.setVisible(false);
            l5.setVisible(true);
            caption.setText("ambulance4");
            l5.add(caption);
            Thread.sleep(2800);
            l5.setVisible(false);
            l6.setVisible(true);
            caption.setText("ambulance5");
            l6.add(caption);
            Thread.sleep(2800);
            l6.setVisible(false);
            l7.setVisible(true);
            ...
            l7.setVisible(false);
            l8.setVisible(true);
            caption.setText("ambulance6");
            l8.add(caption);
            Thread.sleep(2800);
            l8.setVisible(false);
            l9.setVisible(true);
            caption.setText("ambulance7");
            l9.add(caption);
            Thread.sleep(2800);
            l9.setVisible(false);
            l10.setVisible(true);
            caption.setText("ambulance8");
            l10.add(caption);
            Thread.sleep(2800);
            l10.setVisible(false);
            l11.setVisible(true);
            caption.setText("ambulance9");
            l11.add(caption);
            Thread.sleep(2800);
    ...
    public ViewCabs() {
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("cab/booking/system/icons/ambulance1.jpeg"));
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("cab/booking/system/icons/ambulance1.jpeg"));
        ...
        ImageIcon i7 = new ImageIcon(ClassLoader.getSystemResource("cab/booking/system/icons/ambulance6.jpeg"));
        ...
        ImageIcon i10 = new ImageIcon(ClassLoader.getSystemResource("cab/booking/system/icons/ambulance1.jpeg"));
        ...
        ImageIcon i13 = new ImageIcon(ClassLoader.getSystemResource("cab/booking/system/icons/ambulance1.jpeg"));
        ...
        ImageIcon i16 = new ImageIcon(ClassLoader.getSystemResource("cab/booking/system/icons/ambulance3.jpeg"));
        ...
        ImageIcon i19 = new ImageIcon(ClassLoader.getSystemResource("cab/booking/system/icons/ambulance4.jpeg"));
        ...
        ImageIcon i22 = new ImageIcon(ClassLoader.getSystemResource("cab/booking/system/icons/ambulance4.jpeg"));
        ...
        ImageIcon i25 = new ImageIcon(ClassLoader.getSystemResource("cab/booking/system/icons/ambulance2.jpeg"));
        ...
        ImageIcon i28 = new ImageIcon(ClassLoader.getSystemResource("cab/booking/system/icons/ambulance4.jpeg"));
