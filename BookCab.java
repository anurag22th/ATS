...
public class BookCab extends JFrame{  //Forth
    ...
    public BookCab(String username){
        ...
        setTitle("Book Ambulance");
	getContentPane().setBackground(Color.WHITE);
	setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        
        ReservationDetails = new JLabel("BOOK INTRACITY AMBULANCE");
	...
	add(l8);
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("cab/booking/System/icons/ambulance3.jpeg"));
	...
	show.addActionListener(new ActionListener(){
		...
		try{
                    ...
                    if(rs.next()){
                        ...
                        l4.setText("Rs " + rs.getString("cost"));
