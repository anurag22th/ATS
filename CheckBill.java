...
public class CheckBill extends JFrame{
    ...
    CheckBill(String username) {    
      ...
      String[] package1 = new String[]{"package1.png","INTERCITY AMBULANCE BILL", price1};
      String[] package2 = new String[]{"package2.jpg","INTRACITY AMBULANCE BILL",price2};
      String[] package3 = new String[]{"package3.jpg","TRANSPORT BILL", price3};
      
      JTabbedPane tabbedPane = new JTabbedPane();
      JPanel p1 = createPackage(package1);
      tabbedPane.addTab("Intercity Ambulance", null, p1);
      
      JPanel p2 = createPackage(package2);
      tabbedPane.addTab("Intracity Ambulance", null, p2);
    ...
    public JPanel createPackage(String[] pack){
        ...
        JLabel l3 = new JLabel("Transpo Ambulance");
        ...
        JLabel la1 = new JLabel("Ambulance for all!!!");
