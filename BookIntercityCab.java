...
public class BookIntercityCab extends JFrame{  
	...
	setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        ...
        ReservationDetails = new JLabel("BOOK INTERCITY AMBULANCE");
	...
	add(l1);
        ...
        c3.add("MicroAmbulance");
        c3.add("MiniAmbulance");
        c3.add("SUVAmbulance");
	...
	add(l8);
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("cab/booking/System/icons/ambulance4.jpeg"));
